  ...
  return (
    <>
      ...
      <div className=" h-screen w-full flex flex-col items-center justify-center z-10 gap-10">
        ...
        <form className=" flex w-[80%] h-[8vw] lg:h-auto lg:w-[800px] bg-white p-4 shadow-md gap-4 items-center justify-center">
          <input
            type="text"
            name="research"
            id="research"
            placeholder=" Recherche"
            className="flex w-full text-[2vw] lg:text-xl focus:outline-none"
          />
